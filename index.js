...
function lastName(array, name){
  array.name = name;
  return array;
}
console.log(lastName(artists[8], "Vincent Van Gogh"));
...
//   let filteredTwenties=[];
//   for(let i=0; i <  arr.length; i++){
//     if(arr[i].includes(string)){
//       filteredTwenties.push(arr[i]);
//     }
//   }
//   return filteredTwenties;
// }
...
//     return array
//   }
// console.log(addArtist(artists, 20, 'Yufenhiem', '1242-1310', 'Goliath', 'Mexican', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.'))
